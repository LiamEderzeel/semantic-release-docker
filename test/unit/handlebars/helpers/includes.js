...
test("handlebars helpers", async (t) => {
  t.test("includes", async (t) => {
    ...
    t.equal(helpers.includes([], "us", 0), false, "us not in []");
    ...
    t.equal(helpers.includes([3, 4, 50, 100], 3, 0), true, "3 in [3,4,50,100]");
    ...
    t.equal(helpers.includes([], 250, 0), false, "250 not in []");
